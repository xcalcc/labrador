...
public:
  ...
  void FileChanged(clang::SourceLocation Loc,
    ...
    _first.FileChanged(Loc, Reason, FileType, PrevFID);
  ...
  void EndOfMainFile()
           {
    _first.EndOfMainFile();
    _rest.EndOfMainFile();
  }

  void Ident(clang::SourceLocation Loc,
           llvm::StringRef Str) {
    _first.Ident(Loc, Str);
    _rest.Ident(Loc, Str);
  }

  void PragmaDirective(clang::SourceLocation Loc,
           clang::PragmaIntroducerKind Introducer) {
    _first.PragmaDirective(Loc, Introducer);
  ...
  void PragmaComment(clang::SourceLocation Loc,
           ...
           llvm::StringRef Str) {
    _first.PragmaComment(Loc, Kind, Str);
  ...
  void PragmaDiagnostic(clang::SourceLocation Loc,
           ...
           llvm::StringRef Str) {
    _first.PragmaDiagnostic(Loc, Namespace, Mapping, Str);
  ...
  void HasInclude(clang::SourceLocation Loc,
           ...
           clang::SrcMgr::CharacteristicKind FileType) {
    _first.HasInclude(Loc, FileName, IsAngled, File, FileType);
  ...
  void PragmaOpenCLExtension(clang::SourceLocation NameLoc,
           ...
           unsigned State) {
    _first.PragmaOpenCLExtension(NameLoc, Name, StateLoc, State);
  ...
  void MacroExpands(const clang::Token &MacroNameTok,
    ...
    _first.MacroExpands(MacroNameTok, MD, Range, Args);
    _rest.MacroExpands(MacroNameTok, MD, Range, Args);
  }

  void MacroDefined(const clang::Token &MacroNameTok,
           const clang::MacroDirective *MD) {
    _first.MacroDefined(MacroNameTok, MD);
  ...
  void MacroUndefined(const clang::Token &MacroNameTok,
    ...
    _first.MacroUndefined(MacroNameTok, MD, Undef);
  ...
  void If(clang::SourceLocation Loc,
    ...
    _first.If(Loc, ConditionalRange, ConditionalValue);
  ...
  void Elif(clang::SourceLocation Loc,
    ...
    _first.Elif(Loc, ConditionalRange, ConditionalValue, IfLoc);
  ...
  void Ifdef(clang::SourceLocation Loc,
           ...
           const clang::MacroDefinition &MD) {
    _first.Ifdef(Loc, MacroNameTok, MD);
